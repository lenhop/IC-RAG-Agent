"""
Gateway auth, user resolution, and auth API routes.

AuthGuard: JWT validation and user_id resolution for query/rewrite/history endpoints.
Auth routes: register, sign-in, sign-out, me (/api/v1/auth/*).

Merged from: auth.py + auth_routes.py
"""
...
# ---------------------------------------------------------------------------
# AuthGuard — JWT validation and user_id resolution
# ---------------------------------------------------------------------------
