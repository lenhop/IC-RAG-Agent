"""
Gateway intent classification subpackage.

Re-exports public API for split_intents, dual retrieval, resolve_intent,
classify_intent, intent registry, and intent validation.
"""
