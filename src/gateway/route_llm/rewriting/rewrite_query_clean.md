...
- Convert colloquial expressions to formal/standard expressions.
- Preserve all entities exactly: ASINs, SKUs, Order IDs, dates, time ranges, fees, metrics.
- Normalize punctuation: use a single "?" or "!" instead of "???" or "!!".
- Do NOT split the query into sub-questions.
- Do NOT assign workflows or routing.
