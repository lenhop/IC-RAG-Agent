"""
Generation Layer Evaluation - Integration Test

Uses src/rag/evaluation/generation_metrics and dataset_loader.
Runs against real RAG pipeline and amazon_fqa.csv.
Requires LLM API (Deepseek/Qwen) for judge.
"""
...
if __name__ == "__main__":
    ...
    results = evaluator.evaluate_batch(
        pipeline, test_cases, mode="hybrid", verbose=True, progress=True
    )

    output_path = PROJECT_ROOT / "tests" / "evaluation" / "generation_results.json"
